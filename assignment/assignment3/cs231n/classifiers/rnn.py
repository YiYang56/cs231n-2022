...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        captions_in_emb, captions_in_caches = word_embedding_forward(captions_in, W_embed)
        ...
        if self.cell_type == "rnn":
          dcaptions_in_emb, dh0, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dh, rnn_cache)
        elif self.cell_type == "lstm":
          dcaptions_in_emb, dh0, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dh, lstm_cache)
        grads['W_embed'] = word_embedding_backward(dcaptions_in_emb, captions_in_caches)
